...
bool USSETranslatorVisitor::vmad(
    ...
    LOG_DISASM("{} {} {} {} {}", disasm_str, disasm::operand_to_str(decoded_inst.opr.dest, write_mask), disasm::operand_to_str(decoded_inst.opr.src0, write_mask, src0_repeat_offset), disasm::operand_to_str(decoded_inst.opr.src1, write_mask, src1_repeat_offset),
