...
BRIDGE_IMPL(ksceKernelAllocHeapMemoryFromGlobalHeapWithOpt)
BRIDGE_IMPL(ksceKernelAllocHeapMemoryWithOpt1)
BRIDGE_IMPL(ksceKernelAllocHeapMemoryWithOption)
BRIDGE_IMPL(ksceKernelAllocMemBlock)
BRIDGE_IMPL(ksceKernelAllocMemBlockWithInfo)
BRIDGE_IMPL(ksceKernelCreateClass)
...
BRIDGE_IMPL(ksceKernelFindMemBlockByAddrForPid)
BRIDGE_IMPL(ksceKernelFindMemBlockForPid)
BRIDGE_IMPL(ksceKernelFirstDifferentBlock32User)
BRIDGE_IMPL(ksceKernelFirstDifferentBlock64User)
BRIDGE_IMPL(ksceKernelFirstDifferentBlock64UserForPid)
BRIDGE_IMPL(ksceKernelFirstDifferentIntUserForPid)
BRIDGE_IMPL(ksceKernelFreeHeapMemory)
BRIDGE_IMPL(ksceKernelFreeHeapMemoryFromGlobalHeap)
BRIDGE_IMPL(ksceKernelFreeMemBlock)
BRIDGE_IMPL(ksceKernelGUIDGetObject)
BRIDGE_IMPL(ksceKernelGetClassForPidForUid)
BRIDGE_IMPL(ksceKernelGetClassForUid)
BRIDGE_IMPL(ksceKernelGetMemBlockBase)
BRIDGE_IMPL(ksceKernelGetMemBlockMappedBase)
BRIDGE_IMPL(ksceKernelGetMemBlockPARange)
BRIDGE_IMPL(ksceKernelGetMemBlockPaddrListForUid)
BRIDGE_IMPL(ksceKernelGetMemBlockVBase)
...
BRIDGE_IMPL(ksceKernelGetPaddrPairForLargePage)
BRIDGE_IMPL(ksceKernelGetPaddrPairForSmallPage)
BRIDGE_IMPL(ksceKernelGetPhysicalMemoryType)
...
BRIDGE_IMPL(ksceKernelMapUserBlock)
BRIDGE_IMPL(ksceKernelMemBlockDecRefCounterAndReleaseUid)
BRIDGE_IMPL(ksceKernelMemBlockGetInfoEx)
BRIDGE_IMPL(ksceKernelMemBlockGetInfoExForVisibilityLevel)
BRIDGE_IMPL(ksceKernelMemBlockGetSomeSize)
BRIDGE_IMPL(ksceKernelMemBlockIncRefCounterAndReleaseUid)
BRIDGE_IMPL(ksceKernelMemBlockRelease)
BRIDGE_IMPL(ksceKernelMemBlockType2Memtype)
BRIDGE_IMPL(ksceKernelMemBlockTypeGetPrivileges)
BRIDGE_IMPL(ksceKernelMemRangeRelease)
BRIDGE_IMPL(ksceKernelMemRangeReleaseForPid)
BRIDGE_IMPL(ksceKernelMemRangeReleaseWithPerm)
BRIDGE_IMPL(ksceKernelMemRangeRetain)
BRIDGE_IMPL(ksceKernelMemRangeRetainForPid)
BRIDGE_IMPL(ksceKernelMemRangeRetainWithPerm)
BRIDGE_IMPL(ksceKernelMemcpyKernelToUser)
BRIDGE_IMPL(ksceKernelMemcpyKernelToUserForPid)
BRIDGE_IMPL(ksceKernelMemcpyKernelToUserForPidUnchecked)
BRIDGE_IMPL(ksceKernelMemcpyUserToKernel)
BRIDGE_IMPL(ksceKernelMemcpyUserToKernelForPid)
BRIDGE_IMPL(ksceKernelMemcpyUserToUser)
BRIDGE_IMPL(ksceKernelMemcpyUserToUserForPid)
BRIDGE_IMPL(ksceKernelOpenUidForName)
BRIDGE_IMPL(ksceKernelProcModeVAtoPA)
BRIDGE_IMPL(ksceKernelProcUserMap)
BRIDGE_IMPL(ksceKernelRemapBlock)
BRIDGE_IMPL(ksceKernelRoMemcpyKernelToUserForPid)
BRIDGE_IMPL(ksceKernelSetNameForPidForUid)
BRIDGE_IMPL(ksceKernelSetObjectForUid)
BRIDGE_IMPL(ksceKernelStrncpyKernelToUser)
BRIDGE_IMPL(ksceKernelStrncpyUserForPid)
BRIDGE_IMPL(ksceKernelStrncpyUserToKernel)
BRIDGE_IMPL(ksceKernelStrnlenUser)
