...
BRIDGE_DECL(scePowerGetBatteryRemainLevel)
BRIDGE_DECL(scePowerGetBatteryRemainMaxLevel)
...
BRIDGE_DECL(scePowerIsLowBatteryInhibitUpdateDownload)
BRIDGE_DECL(scePowerIsLowBatteryInhibitUpdateReboot)
