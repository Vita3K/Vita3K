...
EXPORT(int, sceSblQafManagerGetQafNameForUser) {
    return UNIMPLEMENTED();
}

EXPORT(int, sceSblQafManagerIsAllowKernelDebugForUser) {
    return UNIMPLEMENTED();
}

EXPORT(int, sceSblQafManagerSetQafTokenForUser) {
    return UNIMPLEMENTED();
}

EXPORT(int, sceSblQafMgrDeleteQafToken2) {
    return UNIMPLEMENTED();
}

EXPORT(int, sceSblQafMgrGetQafName) {
    return UNIMPLEMENTED();
}

EXPORT(int, sceSblQafMgrGetQafToken) {
    return UNIMPLEMENTED();
}

EXPORT(int, sceSblQafMgrGetQafToken2) {
    return UNIMPLEMENTED();
}

EXPORT(int, sceSblQafMgrIsAllowAllDebugMenuDisplay) {
    return UNIMPLEMENTED();
}

EXPORT(int, sceSblQafMgrIsAllowForceUpdate) {
    return UNIMPLEMENTED();
}

EXPORT(int, sceSblQafMgrIsAllowLimitedDebugMenuDisplay) {
    return UNIMPLEMENTED();
}

EXPORT(int, sceSblQafMgrIsAllowMinimumDebugMenuDisplay) {
    return UNIMPLEMENTED();
}

EXPORT(int, sceSblQafMgrIsAllowNonQAPup) {
    return UNIMPLEMENTED();
}

EXPORT(int, sceSblQafMgrIsAllowNpFullTest) {
    return UNIMPLEMENTED();
}

EXPORT(int, sceSblQafMgrIsAllowNpTest) {
    return UNIMPLEMENTED();
}

EXPORT(int, sceSblQafMgrIsAllowRemoteSysmoduleLoad) {
    return UNIMPLEMENTED();
}

EXPORT(int, sceSblQafMgrIsAllowScreenShotAlways) {
    return UNIMPLEMENTED();
}
