...
EXPORT(int, sceJpegArmEncoderEnd) {
    return UNIMPLEMENTED();
}

EXPORT(int, sceJpegArmEncoderGetContextSize) {
    return UNIMPLEMENTED();
}

EXPORT(int, sceJpegArmEncoderInit) {
    return UNIMPLEMENTED();
}

EXPORT(int, sceJpegArmEncoderSetCompressionRatio) {
    return UNIMPLEMENTED();
}

EXPORT(int, sceJpegArmEncoderSetHeaderMode) {
    return UNIMPLEMENTED();
}

EXPORT(int, sceJpegArmEncoderSetOutputAddr) {
    return UNIMPLEMENTED();
}
