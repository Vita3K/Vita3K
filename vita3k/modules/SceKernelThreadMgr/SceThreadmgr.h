...
DECL_EXPORT(int, _sceKernelWaitEvent, SceUID event_id, SceUInt32 bit_pattern, Ptr<SceUInt32> result_pattern, Ptr<SceUInt64> user_data, SceUInt32 *timeout);
DECL_EXPORT(int, _sceKernelWaitEventCB, SceUID event_id, SceUInt32 bit_pattern, Ptr<SceUInt32> result_pattern, Ptr<SceUInt64> user_data, SceUInt32 *timeout);
...
DECL_EXPORT(SceInt32, _sceKernelWaitEventFlag, SceUID evfId, SceUInt32 bitPattern, SceUInt32 waitMode, Ptr<SceUInt32> pResultPat, SceUInt32 *pTimeout);
DECL_EXPORT(SceInt32, _sceKernelWaitLwCondCB, Ptr<SceKernelLwCondWork> pWork, SceUInt32 *pTimeout);
DECL_EXPORT(SceInt32, _sceKernelWaitLwCond, Ptr<SceKernelLwCondWork> pWork, SceUInt32 *pTimeout);
...
DECL_EXPORT(SceInt32, _sceKernelWaitEventFlagCB, SceUID evfId, SceUInt32 bitPattern, SceUInt32 waitMode, Ptr<SceUInt32> pResultPat, SceUInt32 *pTimeout);
...
DECL_EXPORT(int, _sceKernelWaitThreadEnd, SceUID thid, Ptr<int> stat, SceUInt *timeout);
DECL_EXPORT(int, _sceKernelWaitThreadEndCB, SceUID thid, Ptr<int> stat, SceUInt *timeout);
