...
EXPORT(int, sceSblRtcMgrGetCpRtcPhysicalForUser) {
    return UNIMPLEMENTED();
}

EXPORT(int, sceSblRtcMgrGetCpSerialId) {
    return UNIMPLEMENTED();
}

EXPORT(int, sceSblRtcMgrSetCpActivationKey) {
    return UNIMPLEMENTED();
}

EXPORT(int, sceSblRtcMgrSetCpRtcLogical) {
    return UNIMPLEMENTED();
}

EXPORT(int, sceSblRtcMgrSetCpRtcPhysicalAndKey) {
    return UNIMPLEMENTED();
}
