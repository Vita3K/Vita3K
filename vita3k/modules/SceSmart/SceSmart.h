...
BRIDGE_DECL(sceSmartCreateInstantImageTarget)
...
BRIDGE_DECL(sceSmartSceneMappingSetCustomListener)
BRIDGE_DECL(sceSmartSceneMappingSetDenseMapMode)
BRIDGE_DECL(sceSmartSceneMappingSetDispatchMode)
...
BRIDGE_DECL(sceSmartTargetTrackingQuery2)
