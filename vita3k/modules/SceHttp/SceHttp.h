...
BRIDGE_DECL(sceHttpCreateRequest2)
BRIDGE_DECL(sceHttpCreateRequestWithURL)
BRIDGE_DECL(sceHttpCreateRequestWithURL2)
...
BRIDGE_DECL(sceHttpSetInflateGZIPEnabled)
...
BRIDGE_DECL(sceHttpSetResponseHeaderMaxSize)
