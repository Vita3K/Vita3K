...
inline constexpr std::string_view VitaThemeTemplateVersion = "2026.05.19.1";
...
struct VitaThemeInfo {
    ...
    fs::path theme_xml_path;
    std::optional<fs::path> bgm_path;
    fs::path package_thumbnail_path;
    fs::path home_preview_path;
    fs::path lockscreen_preview_path;
...
struct VitaThemeSynthesisResult {
    std::string theme_name;
    std::string selected_background_id;
