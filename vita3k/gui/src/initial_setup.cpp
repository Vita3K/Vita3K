...
void draw_initial_setup(GuiState &gui, EmuEnvState &emuenv) {
    ...
    draw_list->AddRectFilled(VIEWPORT_POS, ImVec2(VIEWPORT_POS.x + VIEWPORT_SIZE.x, VIEWPORT_POS.y + VIEWPORT_SIZE.y), IM_COL32(112.f, 124.f, 246.f, 255.f), 0.f, ImDrawFlags_RoundCornersAll);
    ImGui::SetNextWindowPos(ImVec2(VIEWPORT_POS.x + (98.f * SCALE.x), VIEWPORT_POS.y + (30.f * SCALE.y)), ImGuiCond_Always);
    ...
    ImGui::SetCursorPos(ImVec2(10.f * SCALE.x, VIEWPORT_SIZE.y - BUTTON_SIZE.y - (16.f * SCALE.y)));
    ...
    ImGui::SetCursorPos(ImVec2(VIEWPORT_SIZE.x - BUTTON_SIZE.x - (14.f * SCALE.x), VIEWPORT_SIZE.y - BUTTON_SIZE.y - (16.f * SCALE.y)));
