...
void draw_welcome_dialog(GuiState &gui, EmuEnvState &emuenv) {
    ...
    ImGui::PopStyleColor();
    ImGui::Spacing();
    ImGui::TextColored(GUI_COLOR_TEXT, "%s", lang["RPCSV"].c_str());
    ImGui::Spacing();
    ImGui::Separator();
    ImGui::Spacing();
    ...
    if (ImGui::Button(lang["download_preinst_firmware"].c_str()))
    ...
    ImGui::Spacing();
    ImGui::TextColored(GUI_COLOR_TEXT, "%s", lang["RPCSV_quickstart"].c_str());
    ImGui::SameLine();
    ImGui::SetCursorPosY(ImGui::GetCursorPosY() - 6.f);
    if (ImGui::Button(lang["quickstart"].c_str()))
        open_path("https://RPCSV.org/quickstart.html");
    ImGui::SameLine();
    ...
    if (ImGui::Button(lang["commercial_compatibility_list"].c_str()))
        open_path("https://RPCSV.org/compatibility.html");
    ImGui::SameLine();
    if (ImGui::Button(lang["homebrew_compatibility_list"].c_str()))
        open_path("https://RPCSV.org/compatibility-homebrew.html");
    ImGui::Spacing();
    ImGui::TextColored(GUI_COLOR_TEXT, "%s", lang["welcome_contribution"].c_str());
    ImGui::SameLine();
    if (ImGui::Button("GitHub"))
        open_path("https://github.com/RPCSV/RPCSV");
    ImGui::Spacing();
