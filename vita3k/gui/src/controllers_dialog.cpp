...
static void add_bind_to_table(GuiState &gui, EmuEnvState &emuenv, const SDL_GamepadType type, const SDL_GamepadButton btn) {
    ...
    std::map<SDL_GamepadButton, std::string> buttons_name = {
        ...
        { SDL_GAMEPAD_BUTTON_NORTH, controls["cross_button"].c_str() },
        { SDL_GAMEPAD_BUTTON_EAST, controls["circle_button"].c_str() },
        { SDL_GAMEPAD_BUTTON_SOUTH, controls["square_button"].c_str() },
        { SDL_GAMEPAD_BUTTON_WEST, controls["triangle_button"].c_str() },
    ...
    const auto get_mapped_button_name = [type](const SDL_GamepadButton btn) -> std::string {
        ...
        case SDL_GAMEPAD_TYPE_XBOXONE:
            ...
            case SDL_GAMEPAD_BUTTON_NORTH: return "A";
            case SDL_GAMEPAD_BUTTON_EAST: return "B";
            case SDL_GAMEPAD_BUTTON_SOUTH: return "X";
        ...
        case SDL_GAMEPAD_TYPE_PS5:
            ...
            case SDL_GAMEPAD_BUTTON_NORTH: return "Cross";
            case SDL_GAMEPAD_BUTTON_EAST: return "Circle";
            case SDL_GAMEPAD_BUTTON_SOUTH: return "Square";
            case SDL_GAMEPAD_BUTTON_WEST: return "Triangle";
        ...
        case SDL_GAMEPAD_TYPE_NINTENDO_SWITCH_JOYCON_PAIR:
            ...
            case SDL_GAMEPAD_BUTTON_SOUTH: return "Y";
    ...
    if (has_controllers) {
        ...
        if (ImGui::BeginTable("main", 3, ImGuiTableFlags_NoSavedSettings | ImGuiTableFlags_BordersInnerV)) {
            ...
            for (auto i = 0; i < SCE_CTRL_MAX_WIRELESS_NUM; i++) {
                ...
                if (rebinds_is_open) {
                    const SDL_GUID guid = SDL_GetJoystickGUIDForID(i);
                    ...
                    const auto type = SDL_GetGamepadTypeForID(i);
