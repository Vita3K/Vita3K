...
static void draw_notice_info(GuiState &gui, EmuEnvState &emuenv) {
    ...
    const ImVec2 NOTICE_SIZE = notice_info_count_new ? ImVec2(104.0f * SCALE.x, 95.0f * SCALE.y) : ImVec2(88.f * SCALE.x, 81.f * SCALE.y);
    ...
    const ImVec2 WINDOW_SIZE = notice_info_state ? VIEWPORT_SIZE : (notice_info_count_new ? ImVec2(86.f * SCALE.x, 78.f * SCALE.y) : ImVec2(72.f * SCALE.x, 64.f * SCALE.y));
    ...
    if (notice_info_count_new) {
        ...
        if (gui.theme_information_bar_notice.contains(NoticeIcon::NO))
            ...
            draw_list->AddCircleFilled(ImVec2(VIEWPORT_WIDTH_POS_MAX - (22.5f * SCALE.x), VIEWPORT_POS.y + (15.f * SCALE.y)), 46.f * SCALE.x, IM_COL32(62.f, 98.f, 160.f, 255.f));
    }
