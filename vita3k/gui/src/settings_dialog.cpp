...
void draw_settings_dialog(GuiState &gui, EmuEnvState &emuenv) {
    ...
    if (ImGui::BeginTabItem("Camera")) {
        ...
        ImGui::Combo("Front camera", &front_camera, cameras.data(), cameras.size());
        ...
        if (front_camera >= 2) {
            ...
            ImGui::ColorEdit3("Color##front", (float *)&color);
            ...
            if (emuenv.cfg.front_camera_image.empty()) {
                ImGui::TextColored(GUI_COLOR_TEXT, "%s", "Image not set");
            } else {
        ...
        if (back_camera >= 2) {
            ...
            ImGui::ColorEdit3("Color##back", (float *)&color);
