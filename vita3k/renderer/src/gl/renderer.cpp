...
static std::map<SceGxmColorFormat, std::pair<GLenum, GLenum>> GXM_COLOR_FORMAT_TO_GL_FORMAT = {
    ...
    { SCE_GXM_COLOR_FORMAT_U8U8U8U8_BGRA, { GL_BGRA, GL_UNSIGNED_INT_8_8_8_8 } },
    ...
    { SCE_GXM_COLOR_FORMAT_U8U8_GR, { GL_RG, GL_UNSIGNED_BYTE } },
    ...
    { SCE_GXM_COLOR_FORMAT_F10F10F10U2_RGBA, { GL_RGBA, GL_UNSIGNED_INT_10_10_10_2 } },
